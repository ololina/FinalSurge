...
public class LoginPage extends BasePage {
    ...
    public void loginAccount() {
        ...
        LOGGER.info(String.format("Page %s is opened", LoginPage.class.getName()));
        ...
        LOGGER.info("Valid username and password are entered");
    ...
    public void loginAccountWithInvalidCredentials() {
        ...
        LOGGER.info("Invalid username and password are entered");
        driver.findElement(loginButton).click();
    }

    public boolean isWrongCredentialsMessageDisplayed() {
        LOGGER.info("Wrong password or username entered");
